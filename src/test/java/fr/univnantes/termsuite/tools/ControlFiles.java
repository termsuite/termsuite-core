...
public class ControlFiles {
	...
	private static final Path CONTROL_DIRETCORY_PATH = Paths.get("src", "test", "resources", "fr", "univnantes", "termsuite", "test", "corpus");
	 ...
	 * @see ControlFilesGenerator#toCompoundString(fr.univnantes.termsuite.model.Term)
	 * @param lang
	 * 			the language
	 * @param corpus
	 * 			the test corpus
