...
package fr.univnantes.termsuite.test.unit.uima.engines;
...
public class FixedExpressionSpotterSpec {
	...
	private static final String CAS_URL = "src/test/resources/fr/univnantes/termsuite/test/termsuite/json/cas/french-cas1.json";
	JCas cas;
