...
public class DocumentLogger extends JCasAnnotator_ImplBase {
	...
	public static final String CORPUS_SIZE = "CorspuSize";
	@ConfigurationParameter(name=CORPUS_SIZE, mandatory=false, defaultValue="0")
	private long corpusSize;

	public static final String NB_DOCUMENTS = "NbDocuments";
	@ConfigurationParameter(name=NB_DOCUMENTS, mandatory=false, defaultValue="0")
