 ...
 * @author Damien Cram
 */
public class TerminogyExtractor {
	
	private enum CollectionMode {ISTEX_API, FILESYSTEM, INLINE_TEXT}
	
	
	private static final Logger LOGGER = LoggerFactory.getLogger(TerminogyExtractor.class);
...
//    private static String pipelineCRInputDirectory = null;
	...
	public static void main(String[] args) throws Exception {
		...
		TerminogyExtractor cli = new TerminogyExtractor();
		cli.run(args);
	}
